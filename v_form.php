...
<html>
    ...
    <body>
        ...
        <form actaion ="proses_pendaftaran.php" method = "POST">
        <fieldset>
            ...
            <div>
                ...
                <textarea> "text" name = "alamat" row = "5"> <?php if (isset(_GET['nis'])){echo $siswa['alamat'];}?></textarea>
            </div>
            <div>
                ...
                <?php if($jk=='Laki-Laki'){echo 'checked';}?>>Perempuan
            </td>
<?php }else{
    ?>
    <td><br>
